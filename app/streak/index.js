...
import { format, startOfMonth, endOfMonth, eachDayOfInterval, isSameMonth, isToday, parseISO, subMonths, addMonths, getDay } from 'date-fns';
...
export default function StreakCalendarScreen() {
  ...
  const loadCalendarData = async () => {
    ...
    try {
      ...
      // Get all completed dates - ensure completed is a boolean
      logs.forEach(log => {
      ...
      allLogs.forEach(log => allDates.add(log.date));
